...
@Entity
@Table(name = "tb_consortium_with_exchange_payment")
public class ConsortiumWithExchangePayment extends Payment{
	...
	public ConsortiumWithExchangePayment() {
	}
	
	public ConsortiumWithExchangePayment(Long id, Sale sale, String name, String cnpj, String telephone, Long quota, Long group,
			Double inputvalue, Bank inputBank, Double consortiumValue, Bank consortiumBank, Vehicle vehicle) {
		super(id, sale);
		this.name = name;
		this.cnpj = cnpj;
