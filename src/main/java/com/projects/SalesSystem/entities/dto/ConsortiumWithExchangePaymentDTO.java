...
public class ConsortiumWithExchangePaymentDTO extends PaymentDTO {
	...
	public ConsortiumWithExchangePaymentDTO() {
	}
	
	public ConsortiumWithExchangePaymentDTO(ConsortiumWithExchangePayment obj) {
	...
	public void setExchageVehicle(ExchangeVehicleDTO exchangevehicle) {
